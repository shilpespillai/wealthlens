...
export const CORE_CATEGORY_REGISTRY = [
  ...
  { name: "Groceries", type: "expense", iconId: "shopping-cart", color: "orange", aliases: ["food", "groceries", "supermarket"] },
  ...
  { name: "Fuel & Transport", type: "expense", iconId: "fuel", color: "purple", aliases: ["fuel", "gas", "petrol", "transport", "public transport", "train", "bus", "parking"] },
  { name: "Healthcare", type: "expense", iconId: "activity", color: "yellow", aliases: ["medical", "health", "doctor", "pharmacy", "dentist"] },
  { name: "Lifestyle", type: "expense", iconId: "heart", color: "rose", aliases: ["fun", "entertainment", "lifestyle", "gym", "hobbies", "subscriptions"] },
  ...
  { name: "Shopping", type: "expense", iconId: "shopping-bag", color: "pink", aliases: ["shopping", "clothes", "electronics", "gifts"] },
  ...
  { name: "Transfer", type: "expense", iconId: "arrow-right-left", color: "zinc", aliases: ["transfer", "payment", "bank transfer", "internal transfer"] },
  { name: "Reimbursement", type: "income", iconId: "refresh-cw", color: "teal", aliases: ["reimbursement", "payback", "refund"] },
...
export const resolveCanonicalCategory = (inputName) => {
  ...
  // 3. Passthrough: Return original name instead of "Uncategorized" 
  // to allow user-defined categories to flow through the system.
  return inputName;
};
