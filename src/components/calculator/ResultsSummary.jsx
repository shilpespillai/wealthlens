      ...
      {cards.map((card, i) => {
        ...
        return (
          <motion.div
            ...
            transition={{ delay: i * 0.06 }} className="bg-slate-700 p-5 rounded-2xl backdrop-blur-sm border border-white/10 hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-300 hover:border-white/20">


            <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${card.color} flex items-center justify-center mb-4 shadow-lg`}>
              <Icon className="w-5 h-5 text-white" />
            </div>
            <p className="text-neutral-50 mb-2 text-xs font-bold uppercase tracking-[0.15em]">{card.label}</p>
