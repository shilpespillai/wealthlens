    ...
    <motion.div
      ...
      <div className="bg-indigo-50 rounded-2xl p-5 border border-indigo-200">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              <p className="text-slate-500 mb-2 text-xs font-bold uppercase tracking-wider">CONSERVATIVE</p>
              <p className="text-slate-700 text-xl font-black">{analysis.recommended_rates.conservative}%</p>
            </div>
            <div className="text-center">
              <p className="text-slate-500 mb-2 text-xs font-bold uppercase tracking-wider">MODERATE</p>
              <p className="bg-clip-text text-slate-600 text-xl font-black from-indigo-400 to-violet-400">{analysis.recommended_rates.moderate}%</p>
            </div>
            <div className="text-center">
              <p className="text-slate-500 mb-2 text-xs font-bold uppercase tracking-wider">AGGRESSIVE</p>
              <p className="text-slate-700 text-xl font-black">{analysis.recommended_rates.aggressive}%</p>
            </div>
          </div>
        </div>
      }
